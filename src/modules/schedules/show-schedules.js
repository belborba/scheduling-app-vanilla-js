...
//Precisamos receber os agendamento para exibir.
export function schedulesShow({ dailySchedules }) {
  try {
    //Lipamos a lista primeiro para depois preencher com a novas informações.
    ...
    dailySchedules.forEach((schedule) => {
      ...
      // Renderiza o agendamento na sessão de forma condicional (Manhã, tarde e noite)
      if (hour <= 12) {
